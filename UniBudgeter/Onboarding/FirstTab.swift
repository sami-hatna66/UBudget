    ...
    var body: some View {
        ZStack (alignment: .center) {
            ...
            VStack (alignment: .center) {
                ...
                Text("Before you start budgeting with [appname], we'd like to gather some information about your budgeting needs").foregroundColor(.white).font(Font.custom("DIN", size: 20)).multilineTextAlignment(.center)
