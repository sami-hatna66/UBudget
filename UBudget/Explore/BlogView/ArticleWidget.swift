    ...
    var body: some View {
        VStack(alignment: .leading) {
            Group {
                ...
                Text(article.body)
                    .font(.system(size: 12))
                    .foregroundColor(colorScheme == .light ? .secondary : Color(red: 153/255, green: 153/255, blue: 160/255) )
                    .frame(width: 240, height: 30, alignment: .leading)
                    .padding(.bottom, 10).padding(.leading, 5).padding(.trailing, 5)
            }
        }.background(colorScheme == .light ? Color(red: 246/255, green: 246/255, blue: 246/255) : Color(red: 27/255, green: 28/255, blue: 30/255))
            .clipShape(RoundedRectangle(cornerRadius: CGFloat(15)))
            .scaleEffect(index == swipeIndex ? 1 : 0.9)
            .animation(.easeInOut(duration: 0.3), value: index == swipeIndex ? 1 : 0.9)
    }
}
